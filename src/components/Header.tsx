...
const Header: React.FC = () => {
    ...
    return (
        <motion.header 
            className="fixed left-0 right-0 z-[90] w-full max-w-full"
            transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
        >
            <nav className="relative w-full max-w-full flex justify-between items-center py-4 px-6 md:px-8 lg:px-12 bg-white/80 md:bg-white/40 backdrop-blur-2xl border-b border-white/30 shadow-lg">
                ...
                {/* Logo */}
                <Link href="/" className="flex items-center relative z-10 flex-shrink-0">
                    <Image 
                ...
                <ul className="hidden md:flex absolute left-1/2 -translate-x-1/2 space-x-10 items-center">
                    <li>
                        <Link href="/" className="relative text-foreground hover:text-foreground-accent transition-all duration-300 font-semibold text-base group whitespace-nowrap">
                            Home
                    ...
                    <li>
                        <Link href="/about" className="relative text-foreground hover:text-foreground-accent transition-all duration-300 font-semibold text-base group whitespace-nowrap">
                            About Us
                            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-foreground-accent transition-all duration-300 group-hover:w-full rounded-full" />
                        </Link>
                    </li>
                    <li>
                        <Link href="/products" className="relative text-foreground hover:text-foreground-accent transition-all duration-300 font-semibold text-base group whitespace-nowrap">
                            Products
                            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-foreground-accent transition-all duration-300 group-hover:w-full rounded-full" />
                        </Link>
                    </li>
                    <li>
                        <Link href="/services" className="relative text-foreground hover:text-foreground-accent transition-all duration-300 font-semibold text-base group whitespace-nowrap">
                            Services
                            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-foreground-accent transition-all duration-300 group-hover:w-full rounded-full" />
                        </Link>
                    </li>
                    <li>
                        <Link href="/contact" className="relative text-foreground hover:text-foreground-accent transition-all duration-300 font-semibold text-base group whitespace-nowrap">
                            Contact Us
                            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-foreground-accent transition-all duration-300 group-hover:w-full rounded-full" />
                        </Link>
                    </li>
                ...
                <div className="hidden md:block relative z-10 flex-shrink-0">
                    <Link href="#cta" className="relative text-white bg-black/90 backdrop-blur-sm hover:bg-black hover:shadow-xl hover:shadow-black/30 hover:scale-105 px-9 py-3.5 rounded-full transition-all duration-300 font-bold text-base border border-white/20 whitespace-nowrap">
                        Style.ai
                    </Link>
                </div>
            ...
            >
                <div id="mobile-menu" className="md:hidden w-full max-w-full bg-white/90 backdrop-blur-2xl shadow-lg border-b border-white/30">
